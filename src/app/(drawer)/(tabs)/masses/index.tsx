          ...
          itemDay: {
            idle: ({ isPressed, isWeekend, isToday }) => ({
              container: {
                ...
                backgroundColor: isPressed || isToday ? gold_600 : undefined,
                borderRadius: isPressed && 30,
              },
              content: {
                color: isWeekend && !isPressed ? "black" : undefined,
              },
            }),
            today: ({ isPressed }) => ({
              container: {
            ...
            active: ({ isEndOfRange, isStartOfRange }) => ({
              container: {
                ...
                borderTopLeftRadius: isStartOfRange ? 4 : undefined,
                borderBottomLeftRadius: isStartOfRange ? 4 : undefined,
                borderTopRightRadius: isEndOfRange ? 4 : undefined,
                borderBottomRightRadius: isEndOfRange ? 4 : undefined,
              },
              content: {
                color: "#ffffff",
                fontWeight: "bold",
